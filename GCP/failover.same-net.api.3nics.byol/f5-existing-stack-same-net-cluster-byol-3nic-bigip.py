...
#
# Version 3.13.0
# edited by Paolo Di Liberto to support Internet proxy during deployment. NO proxy authentication supported for now.
  ...
  metadata = {
              'items': [{
                  ...
                  'value': ('\n'.join(['#!/bin/bash',
                                    ...
                                    'fi',
                                    '/usr/bin/curl ' + CURLSTG + ' -s -f --retry 20 -o /config/cloud/f5-cloud-libs.tar.gz https://cdn.f5.com/product/cloudsolutions/f5-cloud-libs/v4.25.0/f5-cloud-libs.tar.gz',
                                    ...
                                    '/usr/bin/curl ' + CURLSTG + ' -s -f --retry 20 -o /var/config/rest/downloads/f5-appsvcs-3.26.1-1.noarch.rpm https://cdn.f5.com/product/cloudsolutions/f5-appsvcs-extension/v3.26.1/f5-appsvcs-3.26.1-1.noarch.rpm',
                                    '/usr/bin/curl ' + CURLSTG + ' -s -f -L --retry 20 -o /var/config/rest/downloads/f5-cloud-failover-1.8.0-0.noarch.rpm https://github.com/F5Networks/f5-cloud-failover-extension/releases/download/v1.8.0/f5-cloud-failover-1.8.0-0.noarch.rpm',
