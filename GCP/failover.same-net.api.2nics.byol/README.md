...
Please note: this template creates the storage bucket in the instances region you specify in the YAML file, while the default one creates the storage bucket in default "us (multiple regions in United States)" location
